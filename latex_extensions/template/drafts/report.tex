...
% proper referencing in subfigure configuration
...
\lhead{\textcolor{gray}{<+Όνομα μαθήματος+>}}\chead{}\rhead{\textcolor{gray}{
<+Εργαστηριακή άσκηση+>\\<+Εκβολή θερμοπλαστικού υλικού+>}}
