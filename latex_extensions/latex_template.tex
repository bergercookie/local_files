...
\lhead{\textcolor{gray}{Συστήματα Αυτομάτου Ελέγχου}\\
\textcolor{gray}{Προαιρετικές Ασκήσεις}}\chead{}\rhead{}
...
%   ΜΟΝΤΕΛΟΠΟΙΣΗΣΗ
%----------------------------------------------------------------------------------------
\input{modelling_part.tex}
%----------------------------------------------------------------------------------------
%   ΑΠΟΚΡΙΣΗ ΧΡΟΝΟΥ
%----------------------------------------------------------------------------------------
\input{time_response_part.tex}

%----------------------------------------------------------------------------------------
%   ΤΟΠΟΣ ΡΙΖΩΝ
%----------------------------------------------------------------------------------------
\input{locus_analysis.tex}

%----------------------------------------------------------------------------------------
%   ΑΠΟΚΡΙΣΗ ΣΥΧΝΟΤΗΤΑΣ
%----------------------------------------------------------------------------------------
\input{frequency_responce.tex}
...
\bibitem{hsme}
	  ...
	  \emph{Ηλεκτρομηχανικά Συστήματα μετατροπής Ενέργειας}.
	  Αθήνα,
	  2011.
\bibitem{mit_book}
	Thomas F. Weiss,
...
\bibitem{golna}
	...
	\emph{Automatic Control Systems},
	9th Edition
	2002
\end{thebibliography}
