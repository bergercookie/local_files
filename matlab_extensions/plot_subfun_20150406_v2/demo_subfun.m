...
% * -nomain     removes the main function of each file
...
% dependencies to its parent instead. in the example below, the function
...
% the names of functions to hide can be given as just a functionname (e.g.
% sub_setup), or the full form with filename (e.g. plot_subfun>sub_setup).
